...
public:
    ...
    void buildSwapNotionalEx(std::string indexId, QuantLib::Real notional, std::string maturity, QuantLib::Real rate, bool firstLegPays,
                   std::string start = std::string(), std::string tradeId = std::string());
    ...
    void buildSwapNotionalEx(std::string indexId, QuantLib::Real notional, std::string maturity, std::string recIndexId, QuantLib::Real spread, bool firstLegPays,
                   std::string start = std::string(), std::string tradeId = std::string(), std::map<std::string, std::string> mapPairs = {});
    void buildFixedLeg(std::string indexId, QuantLib::Real notional, std::string maturity, QuantLib::Real rate,
                   std::string start = std::string(), std::string tradeId = std::string());
    void buildFixedLegNotionalEx(std::string indexId, QuantLib::Real notional, std::string maturity, QuantLib::Real rate,
                   std::string start = std::string(), std::string tradeId = std::string());
